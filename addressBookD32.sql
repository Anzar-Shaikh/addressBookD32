...
INSERT INTO addressbook VALUES ("ANZAR", "SHAIKH", "MAKARANPUR", "KANNAD", "MAHARASHTRA", 431103, "9503849559");
describe addressBook;
select * FROM addressbook;
ALTER TABLE addressBook DROP COLUMN zip;
ALTER TABLE addressBook ADD COLUMN zip VARCHAR(6) AFTER state;
INSERT INTO addressbook VALUES ("ANZAR", "SHAIKH", "MAKARANPUR", "KANNAD", "MAHARASHTRA", "431103", "9503849559");      /* TO ADD VALUES IN TABLE */
INSERT INTO addressbook VALUES ("Naveen","Patekar","Pune Maharashtra","Pune","MAharashtra",411030,"9876543210");
DELETE FROM addressbook WHERE firstName = "ANZAR";
INSERT INTO addressbook  VALUES ("ANZAR", "SHAIKH", "MAKARANPUR", "KANNAD", "MAHARASHTRA", "431103", "9503849559") ;
...
INSERT INTO addressbook VALUES ("anzar","shaikh","kannad","Pune","Maharashtra",411030,"9078751483");
...
UPDATE addressbook SET name = 'Naveen', relation = 'friend' WHERE firstName = 'anzar';
UPDATE addressbook SET name = 'Naveen', relation = 'family' WHERE firstName = 'anzar';
...
INSERT INTO personName VALUES ('1001', "ANZAR", "SHAIKH", '2001');
